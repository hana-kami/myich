/****************************************************************************
** Meta object code from reading C++ file 'picturebutton.h'
**
...
#error "The header file 'picturebutton.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 14, 7), // "entered"
QT_MOC_LITERAL(2, 22, 0) // ""

    },
    "pictureButton\0entered\0"
};
...
void pictureButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        pictureButton *_t = static_cast<pictureButton *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->entered(); break;
        case 1: _t->entered((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (pictureButton::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pictureButton::entered)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (pictureButton::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pictureButton::entered)) {
                *result = 1;
                return;
            }
...
const QMetaObject pictureButton::staticMetaObject = {
    { &QAbstractButton::staticMetaObject, qt_meta_stringdata_pictureButton.data,
      qt_meta_data_pictureButton,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void pictureButton::entered()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void pictureButton::entered(int _t1)
{
